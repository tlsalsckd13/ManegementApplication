package com.example.manegementapplication.StoreListAdapter
...
import kotlinx.android.synthetic.main.custom_list_store.view.*
...
class ListViewAdapter(private val items: MutableList<ListViewItem>): BaseAdapter() {
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) convertView = LayoutInflater.from(parent?.context).inflate(R.layout.custom_list_store, parent, false)
